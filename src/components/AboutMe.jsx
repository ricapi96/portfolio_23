...
function AboutMe() {
  return (
    <section className="about-me">
      ...
      <p>
        When I'm not crafting pixel-perfect interfaces, you can find me exploring the great outdoors, often accompanied by my furry friends. I believe that just as in coding, attention to detail and adaptability are essential when trekking new paths and discovering hidden gems.
      </p>
      <p>
