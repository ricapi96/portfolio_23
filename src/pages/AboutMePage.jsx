...
function AboutMePage() {
  return (
    <section className="about-me">
      ...
      <img src={bigCity} alt="Me with city background" className="big-city" />
      <p>
      ...
      <img src={goosey} alt="Lady no kids" className="goose" />
      <p>
      ...
      <img src={tullip} alt="Me with a flower" className="flower" />
      <p></p>
      <p>
      ...
      <img src={coke} alt="Me with a coke" className="coke" />
    </section>
  );
}
